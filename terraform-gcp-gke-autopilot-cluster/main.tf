...
resource "null_resource" "local_k8s_context" {
  ...
  provisioner "local-exec" {
    ...
    command = "for i in 1 2 3 4 5; do gcloud container clusters get-credentials ${local.gke_cluster_name} --project=${var.project_id} --region=${var.zone} && break || sleep 60; done"
  }
}
