...
service:
  ...
  annotations:
    ...
    controller.autoneg.dev/neg: '{"backend_services":{"80":[{"name":"${var.http_backend_service_name}","max_rate_per_endpoint":100}]},"443":[{"name":"${var.https_backend_service_name}","max_rate_per_endpoint":100}]}}'
  loadBalancerIP: ""
